...
volatile unsigned int pwm3 = 0;
volatile unsigned int pwm4 = 0;
...
void Timer2_ISR (void) interrupt 5
{
	...
	OUT2=pwm_count>pwm3?0:1; //Generates pwm2% duty cycle wave at P2.1
	OUT3=pwm_count>pwm4?0:1; //Generates pwm2% duty cycle wave at P2.1
}
